...
const divideAndConquerSearchComplex = (array, val) => {
	let start = 0;
...
console.log(
	divideAndConquerSearchComplex([1, 3, 5, 7, 8, 9, 11, 12, 13, 15, 20, 22, 23, 30, 45], 7)
);

const divideAndConquerSearchSimple = (array, val) => {
	array.splice(val, array.length);
...
console.log(
	divideAndConquerSearchSimple([1, 3, 5, 7, 8, 9, 11, 12, 13, 15, 20, 22, 23, 30, 45], 7)
);
